...
from tools.market_news import init_market_news
...
def health_check():
    ...
    return jsonify({
        ...
        "tools": ["financial_assistant", "market_indices", "market_sector","compare", "stock_search", "market_news"]
    })
